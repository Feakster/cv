...
\begin{cvlist}{SOFTWARE PACKAGES}
	...
	\item[]
	\textbf{Feakins BG}, Lay-Flurrie SL, Stevens RJ, Greenhalgh T, Holt TA, Kontopantelis E, Smith DM and Gudgin BC. \texttt{QDiabetes}: A package to calculate risk of type 2 diabetes. R package version 1.0-2, \url{https://cran.r-project.org/package=qdiabetes}
